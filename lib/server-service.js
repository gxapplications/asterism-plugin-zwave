...
this.logger.log('####2', this.alarms.length, this.alarms, alarmsOn.length, alarmsOn) // TODO !0: fix, should not add a new notif when alarmIsOn === false, but remove the old notif version
