...
import BrowserZwaveRgbwAction from './scenarii/rgbw-switch-action/browser'
...
import BrowserZwaveSiren6TonesAction from './scenarii/siren-6-tones-action/browser'
...
export default class ZwaveBrowserService {
  constructor ({ getServices, notificationManager, mainState, privateSocket, publicSockets }) {
    ...
    this.scenariiService.registerElementType('zwave-rgbw-switch-action', BrowserZwaveRgbwAction, zwaveRgbwSchema)
    this.scenariiService.registerElementType('zwave-meter-reset-action', BrowserZwaveMeterResetAction, zwaveMeterResetSchema)
    this.scenariiService.registerElementType('zwave-siren-6-tones-action', BrowserZwaveSiren6TonesAction, zwaveSiren6TonesSchema)
