  ...
  scheduleEvents () {
    try {
      this.sourceListener = (nodeId, oldValue, newValue) => {
        ...
        // TODO !5: For later, rely on 2 or 3 samples to avoid reading errors triggering too much. Caution when not enough samples, must take sample time gaps into account!
