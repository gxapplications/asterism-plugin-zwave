...
/*
  ...
  PARTIALLY SUPPORTED:
    <CommandClass id="50" name="COMMAND_CLASS_METER">
      ...
      </Value> ==========================> peut etre utile pour la puissance instantannee. Quelle précision? quelle réactivité?
...
QubinoZmnhad1.meta = {
  ...
  settingPanel: 'qubino-zmnhad1', // TODO
  settingPanelProvidedFunctions: ['getName', 'getLocation', 'setName', 'setLocation',
    ...
    'getConfiguration', 'setConfiguration'], // TODO
  configurations: {
